...
vec_cols_attrition = c('#b3e2cd','#fdcdac','#cbd5e8', '#ffff99')
vec_cols_VE = c('#f4cae4','#e6f5c9','#fff2ae')
vec_cols_age = c('#1b9e77','#d95f02','#7570b3','#e7298a','#66a61e','#e6ab02')
vec_cols_coverage = c('#c7e9b4','#7fcdbb','#41b6c4','#2c7fb8','#253494')
vec_cols_infections = c('#ffffcc','#ffeda0','#fed976','#feb24c','#fd8d3c','#fc4e2a','#e31a1c','#bd0026')
vec_cols_hcws = c('#ffffd9','#edf8b1','#c7e9b4','#7fcdbb','#41b6c4','#1d91c0','#225ea8')
vec_cols_outcomes = c("#003d5c", "#7a4f99", "#ef527a", "#ffa600")
vec_cols_horizon = c('#e41a1c','#377eb8','#4daf4a')
...
vec_endemic_GID_1 = c("NGA.5_1", "NGA.7_1", "NGA.10_1", "NGA.11_1", "NGA.12_1", "NGA.14_1", 
                      "NGA.16_1", "NGA.19_1", "NGA.23_1", "NGA.26_1", "NGA.29_1", "NGA.31_1", 
                      "NGA.32_1", "NGA.35_1")
...
vec_main_outcomes = c("mild", "cases", "deaths", "snhl", "nnd", "fl", "dalys")
